...
- [x] **A:** predictive maintenance + result sheet (hour-level recall 0.44 misses 0.75, 12/15 failures caught, median lead 37 h; electrical/undercarriage weak, see `ml/artifacts/maintenance/README.md`)
